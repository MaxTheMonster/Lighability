"""
Django settings for Lighability project.
...
SECRET_KEY = 't^4zpld=%w37y=4f$$t^e4^j$h19z90l29hk=!ze88h9#5o3a1'
...
WSGI_APPLICATION = 'Lighability.wsgi.application'
